...
Mysql.runQuery = function runQuery(queryText) {
  return new Promise((resolve, reject) => {
    global.dbConnection.query(queryText, (err, data) => {
      if (err) {
        reject(new Error(err));
      }
      resolve(data);
...
Mysql.getTableList = function getTableList() {
  return new Promise((resolve, reject) => {
    global.dbConnection.query('SHOW TABLES', (err, data) => {
      if (err) {
        reject(new Error(err));
      }
      resolve(data);
...
Mysql.getFieldList = function getFieldList(table) {
  return new Promise((resolve, reject) => {
    global.dbConnection.query(`DESCRIBE ${table}`, (err, data) => {
      if (err) {
        reject(new Error(err));
      }
      resolve(data);
